...
<style>
  ...
  .floating-button:hover .rocket {
    animation: flyRocket 2s infinite;
  }
</style>

<section id="home" class="bg-cover bg-no-repeat relative overflow-hidden" style="background-image: url('https://i.imgur.com/TOYULvY.gif'); background-size: cover;">
    <div class="grid py-8 px-4 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="place-self-center mr-auto lg:col-span-7 futuristic-text">
            <h1 class="mb-4 max-w-2xl text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl dark:text-white futuristic-heading animate__animated animate__fadeInDown">
                @settings('portal::title', '🚀 Server Hosting')
            </h1>
            <p class="mb-6 max-w-2xl font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400 futuristic-text animate__animated animate__fadeInLeft">
                @settings('portal::description', 'Unlock a world of hosting possibilities with Shadow Hosting! Launch your servers today for as low as $1/GB. Our cutting-edge technology ensures your online ventures run seamlessly 24/7.')
            </p>
            <div class="flex items-center space-x-4 mb-8">
                <a href="#pricing"
                   class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-gradient-to-r from-primary-700 to-primary-900 hover:bg-gradient-to-r from-primary-800 to-primary-1000 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900 futuristic-button animate__animated animate__fadeInUp floating-button">
                    @settings('portal::button',  __('🌐 Explore Plans') )
        ...
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex futuristic-image animate__animated animate__fadeInRight">
            <img
                ...
                alt="{!! __('mockup') !!}" class="rounded-lg shadow-xl futuristic-image">
        </div>
    </div>
    <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-b from-transparent to-black h-16"></div>
</section>
...
<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 rotating-grid">
        <h2 class="mb-8 text-4xl font-extrabold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-5xl pulsating-title">{!! __('client.host_favorite_games') !!}</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8 text-gray-500 sm:gap-12 dark:text-gray-400">
            <a href="#" class="flex flex-col items-center justify-center p-6 bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-300 shadow-lg">
...
<section id="features" class="bg-gray-50 dark:bg-gray-800">
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="mb-8 max-w-screen-md lg:mb-16">
            <h2 class="mb-4 text-4xl font-extrabold text-gray-900 dark:text-white pulsating-title">{!! __('client.our_game_anel') !!}</h2>
                    ...
                    <article class="max-w-xs hover:shadow-lg transition-shadow duration-300">
                        <div class="image-container">
                            <a href="{{ url()->current() }}?category={{ $category->link }}#pricing">
                                <img src="{{ $category->icon() }}" class="mb-5 rounded-lg" alt="{{ $category->name }}"
                                    style="height: 200px;">
                            </a>
                        </div>
